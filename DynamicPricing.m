%% Dynamic Network Slicing by Adjusting Resource Price
...
%% Note
% 1. Compared with the shortest path, longer path will be sold at a chiper price to
...
%
% 2. The cost function of underlying resources add a penalty. 