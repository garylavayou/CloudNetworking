...
plot_row = floor(num_figure/plot_col);
h1 = subplot(plot_row,plot_col, 1);
this.Topology.plot('XData',this.Topology.Nodes.Location(:,2), ...
    'YData', this.Topology.Nodes.Location(:,1), ...
...
for i = 2:num_figure
    ...
    dg.plot(...
        'XData', this.Topology.Nodes.Location(this.slices{i-1}.VirtualNodes.PhysicalNode,2),...
        'Ydata', this.Topology.Nodes.Location(this.slices{i-1}.VirtualNodes.PhysicalNode,1),...
