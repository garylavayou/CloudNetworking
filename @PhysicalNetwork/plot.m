...
for i = 2:num_figure
    ...
    dg.plot(...
        'XData', this.Topology.Nodes.Location(this.slices{i-1}.VirtualNodes.PhysicalNode,1),...
        'Ydata', this.Topology.Nodes.Location(this.slices{i-1}.VirtualNodes.PhysicalNode,2),...
