...
for i = 1:length(type_index)
    switch type_index(i)
        ...
        case 31     % Type 1 for experiment 3
            ...
            slice_template(i).Pattern = FlowPattern.RandomInterDataCenter;
            slice_template(i).Weight = 40;
            slice_template(i).NumberPaths = 1;
        ...
        case 32      % Type 2 for experiment 3
            ...
            slice_template(i).Pattern = FlowPattern.RandomInterBaseStation;
        ...
        case 33      % Type 3 for experiment 3
            ...
            slice_template(i).Pattern = FlowPattern.RandomDataCenter2BaseStation;
        ...
        case 41     % Type 1 for experiment 4: dynamic flow arrival and departure.
            ...
            % dynamic attributes.
            slice_template(i).NumberFlows = 60;         % 25/45
        ...
        case 43     % Type 3 for experiment 4
            ...
            slice_template(i).Pattern = FlowPattern.RandomDataCenter2BaseStation;
        case 44     % Type 1 for experiment 4-2: EventDrivenNetork
            ...
            slice_template(i).ArrivalRate = 0.05;   % 0.05 arrivals/hour  =>  20 hours/arrival
            slice_template(i).ServiceInterval = 100;
            slice_template(i).NumberFlows = 60;
            slice_template(i).Flow.ArrivalRate = 30; % 25 arrivals/hour  
            slice_template(i).Flow.ServiceInterval = 0.5; 
            slice_template(i).Pattern = FlowPattern.RandomMultiFlow;
        case 45     % Type 2 for experiment 4-2: EventDrivenNetork
            ...
            slice_template(i).Flow.ServiceInterval = 0.1; 
            slice_template(i).Pattern = FlowPattern.RandomMultiFlow;
        case 46     % Type 3 for experiment 4-2: EventDrivenNetork
