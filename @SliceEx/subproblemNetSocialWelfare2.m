...
%     x(x<10^-5) = 0;
    ...
    znpf = reshape(this.z_npf, this.NumberVirtualNodes, this.NumberPaths, this.NumberVNFs); % FOR DEBUG
        ...
        if p_reserved > 1
            ...
            for p = pid'
                ...
                for v = 1:this.NumberVNFs
                    ...
                    z_id = nid(idn(1:n_reserved))+(p-1)*this.NumberVirtualNodes...
                        +(v-1)*this.NumberVirtualNodes*this.NumberPaths;
    ...
    fval = Slice.subproblemObjective([this.x_path; this.z_npf], lambda, this);
